...
def preprocess_code(code: str, dataset: str, prog_lang: str, task: dict, test_key: str, entry_point_key: str) -> str:
...
def eval(dataset: str, model: str, n: int, t_reference: float, t_samples: float, trial: int, prog_lang: str, 
                    tasks: List[Dict], test_key: str, entry_point_key: str = None) -> None:
...
def eval_APPS(random: bool, sample_size: int, prog_lang: str, model: str="gpt4-api", n: int=5, t_reference: float=0.7, t_samples: float=0.7, trial: int=1) -> None:
    tasks = load_dataset(dataset=APPS, random=random, sample_size=sample_size)
...
def evaluate_dataset(dataset: str, prog_lang: str, random: bool, sample_size: int, model: str, n: int, t_reference: float, t_samples: float, trial: int) -> None:
